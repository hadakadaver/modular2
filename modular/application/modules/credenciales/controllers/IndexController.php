...
class Credenciales_IndexController extends Zend_Controller_Action
{
    ...
    public function indexAction()
    {
        ...
        $albums = new Credenciales_Model_DbTable_Credencials();
        $this->view->albums = $albums->fetchAll($albums->select()->order('id DESC')); 
    }

    public function addAction()
    {
        $form = new Credenciales_Form_Credencial();
