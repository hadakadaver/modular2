...
class Viewubicacion_IndexController extends Zend_Controller_Action
{
    ...
    public function indexAction()
    {
        ...
        $albums = new Viewubicacion_Model_DbTable_Ubicacions();
        $this->view->albums = $albums->fetchAll($albums->select()->order('id DESC')); 
    }

    public function addAction()
    {
        $form = new Viewubicacion_Form_Ubicacion();
